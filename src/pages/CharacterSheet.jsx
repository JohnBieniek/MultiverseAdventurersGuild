...
const sectionIcons = { 'Combat Summary': FaFistRaised, Stats: FaChartBar, Skills: FaStar, Attack: FaBullseye, Weapons: FaFistRaised, Talents: FaMagic, 'Items & Traits': FaFlask, Contacts: FaUsers, 'Session Notes': FaStickyNote }
const vitalIcons = { Initiative: FaCrosshairs, HP: FaHeartbeat, 'Temp HP': FaHeart, Defense: FaShieldAlt, Resilience: FaHeart, Ego: FaBrain, Energy: FaBolt, 'Max Force': FaSun, 'Talent Slots': FaMagic }
